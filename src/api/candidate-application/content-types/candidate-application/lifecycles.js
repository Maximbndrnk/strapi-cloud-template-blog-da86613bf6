          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="640" style="width:100%;max-width:640px;">
            ...
            <tr>
              <td style="background:#FFFFFF;border-radius:12px;padding:32px 22px;">
                <h1 style="margin:0 0 28px 0;font-family:Arial,sans-serif;font-size:40px;line-height:130%;font-weight:700;color:#161616;">
                  Thank You for Your Application to Tallium <span style="font-weight:400;">&#129505;</span>
                </h1>

                <p style="margin:0 0 16px 0;font-family:Arial,sans-serif;font-size:32px;line-height:140%;font-weight:400;color:#161616;">
                  Dear Candidate,
                </p>

                <p style="margin:0 0 12px 0;font-family:Arial,sans-serif;font-size:16px;line-height:150%;font-weight:400;color:#161616;">
                ...
                <p style="margin:0 0 32px 0;font-family:Arial,sans-serif;font-size:16px;line-height:150%;font-weight:400;color:#161616;">
                  Thank you once again for considering Tallium. We wish you every success in your career journey!
                </p>

                <p style="margin:0;text-align:center;font-family:Arial,sans-serif;font-size:16px;line-height:150%;font-weight:700;color:#161616;">
                  Kind regards,<br />
                  Tallium Team
                </p>
              </td>
            ...
            <tr>
              <td style="padding-top:18px;">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#161616;border-radius:12px;padding:22px 20px;">
                  <tr>
                    <td align="center" style="padding:0 0 18px 0;font-family:Arial,sans-serif;font-size:16px;line-height:150%;font-weight:700;color:#FFFFFF;">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #2F2F2F;border-radius:12px;">
                              <tr>
                                <td style="padding:14px 14px 16px 14px;">
                                  ...
                                  <p style="margin:0 0 6px 0;font-family:Arial,sans-serif;font-size:16px;line-height:150%;font-weight:600;color:#FFFFFF;">Linkedin</p>
                                  <p style="margin:0;font-family:Arial,sans-serif;font-size:14px;line-height:150%;font-weight:400;color:#FFFFFF;">Company news, updates, and industry insights.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #2F2F2F;border-radius:12px;">
                              <tr>
                                <td style="padding:14px 14px 16px 14px;">
                                  ...
                                  <p style="margin:0 0 6px 0;font-family:Arial,sans-serif;font-size:16px;line-height:150%;font-weight:600;color:#FFFFFF;">Instagram</p>
                                  <p style="margin:0;font-family:Arial,sans-serif;font-size:14px;line-height:150%;font-weight:400;color:#FFFFFF;">Meet our team and get a glimpse of our culture. &#128522;</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #2F2F2F;border-radius:12px;">
                              <tr>
                                <td style="padding:14px 14px 16px 14px;">
                                  ...
                                  <p style="margin:0 0 6px 0;font-family:Arial,sans-serif;font-size:16px;line-height:150%;font-weight:600;color:#FFFFFF;">Facebook</p>
                                  <p style="margin:0;font-family:Arial,sans-serif;font-size:14px;line-height:150%;font-weight:400;color:#FFFFFF;">Follow us for more updates and company news</p>
                                </td>
                              </tr>
                            </table>
                          </td>
